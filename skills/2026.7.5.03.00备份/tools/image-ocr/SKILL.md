...
- [qq-document-processor](skill:tools/qq-document-processor): For .docx/.doc document attachments from QQ (as opposed to image/screenshot attachments handled by this skill).
